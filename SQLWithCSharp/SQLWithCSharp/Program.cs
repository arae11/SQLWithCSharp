        ...
        static void Main(string[] args)
        {
            ...
            using (var connection = new SqlConnection(@"Data Source=(localdb)\ProjectsV13;Initial Catalog=Northwind;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False"))
            {
                ...
                using (var updateCustomerCommand = new SqlCommand("UpdateCustomer", connection))
                {
                    ...
                    updateCustomerCommand.Parameters.AddWithValue("ID", "THECR");
                    updateCustomerCommand.Parameters.AddWithValue("NewName", "Liu Wang");
                ...
                // UPDATE
                //string sqlUpdateString = $"UPDATE CUSTOMERS SET CITY = 'Barcelona' WHERE CustomerID = 'BEAV'";
                ...
                //    $"VALUES('{newCustomer.CustomerID}','{newCustomer.ContactName}'," +
